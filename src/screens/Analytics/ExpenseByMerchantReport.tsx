...
const data = [
  { id: '1', merchant: 'Amazon', count: 5, amount: '2000' },
  { id: '2', merchant: 'Uber', count: 3, amount: '450' },
  { id: '3', merchant: 'Starbucks', count: 2, amount: '150' },
];

const ExpenseByMerchantReport = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={['#8E2DE2', '#6A0DAD']} style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Expense by Merchant</Text>
        ...
        {stackedView ? (
          ...
          <>
            <View style={styles.tableHeader}>
              <Text style={styles.tableColHeader}>Merchant</Text>
...
export default ExpenseByMerchantReport;
